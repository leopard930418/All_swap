...
export class Brt {
  constructor(provider, networkId, testing, options) {
    ...
    this.HopeNobtAddress = contractAddresses.HopeNobt[networkId]
    this.BroilerPlusAddress = contractAddresses.BroilerPlus[networkId]
    this.DistributorAddress = contractAddresses.Distributor[networkId]
